...
//turn to QString for visual presentation
...
//using a 128 bits key to encrypt the plain text, then using the given initial vector to start encryption
//using stfEncryptor to deal with padding and buffering
...
//decrypt the hex using AES-128
//using a 128 bits key and an initial vector to decrypt the hex
//using stfEncryptor to deal with padding and buffering
//ref: https://stackoverflow.com/questions/12306956/example-of-aes-using-crypto
